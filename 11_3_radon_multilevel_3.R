...
#' date: 1 Nov 2018 (updated 28 Oct 2021)
#' output:
#'     github_document:
#'         pandoc_args: --webtex
#' ---
...
#' predictor, the county-level variance is now markedly reduced. The
#' county-level variance (0.02) is now about five times less than without
#' uranium as a predictor (0.1) because *logu* is accounting for most of the
...
#' in each panel are now partly predicted by the uranium level in a county.
#' 
