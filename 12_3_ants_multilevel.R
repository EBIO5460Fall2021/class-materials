...
#' date: 11 Nov 2020 (minor updates 9 Nov 2021)
#' output:
#'     github_document:
#'         pandoc_args: --webtex
#' ---
...
#' We can include any extra variance by using a plot level error term.
#'
...
#' overdispersion term (compare to `09_8_ants_bayesian_GLM.md`).
...
#' `09_8_ants_bayesian_GLM.md`). However, the decline with latitude is a little
